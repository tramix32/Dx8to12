...
struct TextureStageState {
  ...
  // Bookkeeping only -- the third argument for D3DTOP_MULTIPLYADD/LERP and
  // the result-register redirect. Neither of those ops is generated by
  // ApplyOperation (ff_pixel_shader.cpp) yet, so these don't affect
  // rendering; storing them just lets Set/GetTextureStageState round-trip
  // instead of hitting GetAtIndex's FAIL for games that set them.
